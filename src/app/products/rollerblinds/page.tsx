...
export default function RollerblindsPage() {
  const products = getProductsByCategory("rollerblinds");
    ...
    <div className="px-6 py-12 sm:py-16">
      <div className="mx-auto max-w-5xl">
        ...
        <nav className="mb-10 flex items-center gap-2 text-sm text-muted">
          ...
          <span className="text-foreground">Rollerblinds</span>
        </nav>
        ...
        <div className="mb-12">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted max-w-2xl">
            Browse our collection of made-to-measure rollerblinds. Choose your
            color and configure your exact dimensions for a perfect fit.
          </p>
        </div>
